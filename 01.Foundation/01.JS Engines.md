...
- Their purpose is to convert a source code into a machine readable code. But follow different approaches to achieve so.
...
- After compilation we get an executable that can be run by machine.

## Benifits of compiler

- Compiled code is highly optimized and runs faster as we have machine ready optimized code.
